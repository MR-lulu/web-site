    ...
    <div class="form-1">
      ...
      <el-form :model="formData" :rules="rules" ref="formData" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item :label="$t('rs.moduleA.20000000016') /*关于我们*/" prop="about">
          <el-input v-model="formData.about" type="textarea"
                    :placeholder="$t('rs.moduleA.20000000118') /*请输入关于我们*/"></el-input>
        </el-form-item>
        <el-form-item :label="$t('rs.moduleA.20000000119') /*自定义信息*/" prop="selfInfo">
          <el-input v-model="formData.selfInfo" type="textarea"
                    :placeholder="$t('rs.moduleA.20000000120') /*请输入自定义信息*/"></el-input>
        </el-form-item>
