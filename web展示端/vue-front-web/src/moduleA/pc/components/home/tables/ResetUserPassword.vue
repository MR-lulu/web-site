  ...
  <div class="resetUserPassword">
    ...
    <div class="user-table">
      <el-table
        ...
        <el-table-column prop="userId" width="100" :label="$t('rs.moduleA.20000000021')  /*编号*/" sortable
                         :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="username" :label="$t('rs.moduleA.20000000012')  /*账号*/"
                         :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="phone" :label="$t('rs.moduleA.20000000047') /*手机号*/"
                         :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="mail" :label="$t('rs.moduleA.20000000048') /*邮箱*/"
                         :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="level" :label="$t('rs.moduleA.20000000049') /*类型*/" sortable
