...
CREATE TABLE `parts` (
  ...
  `resource_1` varchar(1000) NOT NULL DEFAULT '',
  `resource_2` varchar(1000) NOT NULL DEFAULT '',
  `resource_3` varchar(1000) NOT NULL DEFAULT '',
  `resource_4` varchar(1000) NOT NULL DEFAULT '',
  `resource_5` varchar(1000) NOT NULL DEFAULT '',
  `status` int(1) NOT NULL DEFAULT '0' COMMENT '状态',
  `server_create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `server_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `remarks` varchar(1000) NOT NULL DEFAULT '' COMMENT '备注',
