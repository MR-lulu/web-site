    ...
    <div class="form-1">
      ...
      <el-form :model="formData" :rules="rules" ref="formData" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item :label="$t('rs.moduleA.20000000133') /*所有者简介*/" prop="ownerShortInfo">
          <el-input v-model="formData.ownerShortInfo" type="textarea" :placeholder="$t('rs.moduleA.20000000134') /*请输入所有者简介*/"></el-input>
        </el-form-item>
        <el-form-item :label="$t('rs.moduleA.20000000135') /*网站备注*/" prop="remarks">
          <el-input v-model="formData.remarks" type="textarea" :placeholder="$t('rs.moduleA.2000000036') /*请输入网站备注*/"></el-input>
        </el-form-item>
